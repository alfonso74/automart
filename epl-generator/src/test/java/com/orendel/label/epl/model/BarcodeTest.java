...
public class BarcodeTest {
	...
	public void testGetDataCharsCount_7Numeric() {
		Barcode barcode = new Barcode(BarcodeType.Code128, BarcodeNarrowBarWidth.TWO, 65, "1116433");
	...
	public void testGetDataCharsCount_6Numeric() {
		Barcode barcode = new Barcode(BarcodeType.Code128, BarcodeNarrowBarWidth.TWO, 65, "111643");
		int dataCharacters = barcode.getDataCharsCount();
	...
	public void testGetDataCharsCount_3Numeric() {
		Barcode barcode = new Barcode(BarcodeType.Code128, BarcodeNarrowBarWidth.TWO, 65, "111");
		int dataCharacters = barcode.getDataCharsCount();
	...
	public void testGetDataCharsCount_EmptyString() {
		Barcode barcode = new Barcode(BarcodeType.Code128, BarcodeNarrowBarWidth.TWO, 65, "");
		int dataCharacters = barcode.getDataCharsCount();
